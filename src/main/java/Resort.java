...
public record Resort(
        ...
        String url, Dictionary.Language lang
) {
    public Resort(String name, String updateTime, String openDate, OpenStatus openStatus, Country country, String url, Dictionary.Language lang) {
        this(name, updateTime, openDate, "N/A", "N/A", "N/A",
                "N/A", "N/A", "N/A", "N/A", openStatus, country, url, lang);
    }
